      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="border-b border-gray-200 px-6 py-4 bg-white flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <Link
              href="/bulkUpload"
              className="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-500 text-white font-medium rounded-lg shadow-sm hover:from-purple-700 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200"
            >
